...
extension UIViewController {
    public func canPerformSegue(with identifier: String) -> Bool {
...
extension UIAlertAction{
    public convenience init(title:String?, style:UIAlertAction.Style, image:UIImage? = nil, descriptiveText:String? = nil, handler:((UIAlertAction)->Void)?) {
        self.init(title: title, style: style, handler: handler)
        self.image = image
        self.descriptiveText = descriptiveText
    }
    public convenience init(title:String?, style:UIAlertAction.Style, image:UIImage? = nil, titleTextAlignment:NSTextAlignment? = nil, handler:((UIAlertAction)->Void)?) {
        self.init(title: title, style: style, handler: handler)
        self.image = image
